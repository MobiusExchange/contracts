...
contract mETHAsset is Initializable, VariantAsset {
    ...
    function getRelativePrice() external view override returns (uint256) {
        ...
        require(timestamp > block.timestamp - 1 days, "MBS: mETHAsset pricefeed is too old");
        require(value > 1e18, "MBS: mETHAsset price is too low");
